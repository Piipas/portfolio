...
const CardBackSide = ({
  ...
  return (
    ...
    >
      <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start max-w-sm mx-auto p-4 relative bg-white dark:bg-black w-full h-full">
